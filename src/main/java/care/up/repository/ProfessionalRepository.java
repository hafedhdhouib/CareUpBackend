...
public interface ProfessionalRepository extends JpaRepository<Professional, Long> {
    ...
    @Query("SELECT p FROM Professional p WHERE p.profession NOT LIKE '%en_attent%' AND p.profession NOT LIKE '%_desactiver%' AND p.profession NOT LIKE '%_archiver%'")
	public Page<Professional> findProfessionsNotContainingEnAttentOrDesactiverOrArchiver(Pageable pageable);

    @Query("SELECT p FROM Professional p WHERE p.profession LIKE '%_desactiver%'")
	public Page<Professional> findProfessionnelsDesactiver(Pageable pageable);

    @Query("SELECT p FROM Professional p WHERE p.profession LIKE '%_archiver%'")
	public Page<Professional> findProfessionnelsArchiver(Pageable pageable);

    
    @Query("SELECT p FROM Professional p WHERE p.profession LIKE '%en_attent%'")
